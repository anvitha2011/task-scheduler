...
import com.anvitha.scheduler.dlq.DeadLetterQueue;
...
import com.anvitha.scheduler.model.TaskStatus;
import com.anvitha.scheduler.pool.CustomThreadPool;
import com.anvitha.scheduler.pool.TaskEventListener;
 ...
 *
 * <p><strong>ANVITHA Interview 2-Minute Architecture Walkthrough:</strong>
 * <ol>
...
public class TaskSchedulerService implements AutoCloseable {
    ...
    public List<com.anvitha.scheduler.pool.WorkerThread> getWorkers() {
